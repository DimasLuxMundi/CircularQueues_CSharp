...
namespace CircularQueues_CSharp
{
    class Queues
    {
        ...
        public void insert(int element)
        {
            ...
            {
                //if the REAR at the last position of the array, then the value of REAR is set to 0 that corresponds to the first position of the array
                if (REAR == max - 1)
                    REAR = 0;
                else
            ...
            //Once the position of REAR is determined, then element is added at its proper place
        ...
        public void remove()
        {
            ...
            {
                //if the element to be deleted is at the last position of the array, then the value of FRONT is set to 0 i.e to the fisrt element of the array.
                if (FRONT == max - 1)
                    FRONT = 0;
                else
        ...
        public void display()
        {
            ...
            else
            {
                ...
                FRONT_position = 0;
                //traverses the array till the last element present in the queues.
                while(FRONT_position <= REAR_position)
                {
                    Console.Write(queue_array[FRONT_position] + "  ");
                    FRONT_position++;
